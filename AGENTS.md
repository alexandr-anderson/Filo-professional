...
**Дизайн-система (rebild «Ателье глазури»):** бисквит `#E4E1D9`, оксид `#131110`, кобальт `#17325C`, селадон `#6E9083`, бычья кровь `#7E2E1E` (≤3%), молочная `#F7F5F0`. Шрифты **Vollkorn** + **Onest** + **JetBrains Mono**. Радиусы 0, мягкие швы и glaze-материальность. Главная — hero-kiln; каталог — shelf-grid; заказ — `/order.html` (наряд-заказ + Telegram). Не возвращать pills, Piazzolla/paper/blush без явной просьбы.
